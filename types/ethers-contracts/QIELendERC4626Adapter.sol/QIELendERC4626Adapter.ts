...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface QIELendERC4626AdapterInterface extends Interface {
    getFunction(nameOrSignature: "allowance" | "approve" | "asset" | "balanceOf" | "cToken" | "convertToAssets" | "convertToShares" | "decimals" | "deposit" | "maxDeposit" | "maxMint" | "maxRedeem" | "maxWithdraw" | "mint" | "name" | "previewDeposit" | "previewMint" | "previewRedeem" | "previewWithdraw" | "redeem" | "symbol" | "totalAssets" | "totalSupply" | "transfer" | "transferFrom" | "withdraw"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'withdraw', data: BytesLike): Result;
  ...
  export interface QIELendERC4626Adapter extends BaseContract {
    
    connect(runner?: ContractRunner | null): QIELendERC4626Adapter;
    waitForDeployment(): Promise<this>;

    interface: QIELendERC4626AdapterInterface;
...
getFunction(nameOrSignature: 'balanceOf'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'cToken'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
