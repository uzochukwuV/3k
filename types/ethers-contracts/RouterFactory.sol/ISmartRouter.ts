...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface ISmartRouterInterface extends Interface {
  ...
  export interface ISmartRouter extends BaseContract {
    
    connect(runner?: ContractRunner | null): ISmartRouter;
    waitForDeployment(): Promise<this>;

    interface: ISmartRouterInterface;
