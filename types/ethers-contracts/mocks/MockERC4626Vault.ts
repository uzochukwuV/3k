...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface MockERC4626VaultInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'withdraw', data: BytesLike): Result;
  ...
  export interface MockERC4626Vault extends BaseContract {
    
    connect(runner?: ContractRunner | null): MockERC4626Vault;
    waitForDeployment(): Promise<this>;

    interface: MockERC4626VaultInterface;
